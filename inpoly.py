...
def main():
	#set your sample points here, any number is fine but order matters
	#WARNING: This program tends to fail on corner intercepts (with only really happen with integers, but still)
	...
	pointlist = [point1, point3, point2, point4] #extend this list to have n sided polygons
	poly = Polygon(pointlist)
	print("polygon initialized")
	
	useSample = input("Use sample point? (53.537481, -113.504401) y/n: ")
	if useSample == 'y':
		testx = 53.537481	# for use in testing
		testy = -113.504401
	else:
